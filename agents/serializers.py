...
from .models import Agent, AgentUserTool, ElevenLabsVoice, UserTool
...
class AgentUserToolMiniSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AgentUserTool
        fields = [
            "id", "user_tool_id", "name", "description",
            "tool_type", "parameters", "is_active",
        ]
...
class AgentListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "status", "language", "phone_number", "user_tools",
...
class AgentDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "phone_number", "user_tools", "created_at", "updated_at",
        ]
        read_only_fields = ["id", "status", "created_at", "updated_at"]
